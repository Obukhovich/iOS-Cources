...
let allTime = brushTeeth + uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch

let haveToDo = finishHomework + uploadPhotos
let likeToDo = brushTeeth + chooseClothes + shower + fixLunch
let doNotLikeToDo = goJogging
