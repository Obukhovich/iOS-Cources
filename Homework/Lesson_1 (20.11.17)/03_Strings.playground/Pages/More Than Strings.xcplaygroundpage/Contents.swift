...
let name2 = "Ekaterina"
let money = 6200
let adjectiveNoun = "beautiful car"
let nounPlace = "car parking"
let positiveEmotion = "happy"
let negativeEmotion = "distressed"
let negativeNoun = "scratched"

let myStory = "Today was a big day for \(name1) and \(name2). They had finally saved up \(money) dollars and were going to buy a \(adjectiveNoun). They went to the \(nounPlace) and feeling very \(positiveEmotion). But then they felt \(negativeEmotion). The car was \(negativeNoun)!"
